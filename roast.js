...
/**
 * Describes the image by generating a description using the generative model.
 * @param {Object} img - The image object containing path and mimetype.
 * @returns {Promise<string>} - The generated description of the image.
 */
export async function describeImage(img) {
    ...
    // Delete the uploaded image from local filesystem
...
/**
 * Generates a roast based on the image description.
 * @param {string} img - The image to generate a roast for.
